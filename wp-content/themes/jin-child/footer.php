		...
		<div class="fixed-btn">
		  <div class="inner">
		    <ul class="fixed-btn-list">
		      ...
		      <li class="fixed-btn-item">
		        <a class="fixed-btn-item__link fixed-btn-item__link--form" href="<?php echo home_url(); ?>/order">
		          <i class="fas fa-envelope"></i>ご注文はこちら
		        </a>
		      </li>
		    </ul>
		  </div>
...
jQuery(function() {
    jQuery('.portfolioList li').matchHeight();
});
</script>
<!--./custom js/css-->
